        ...
        return (
            <div>
                <Modal isOpen={this.props.search.searchModal} toggle={this.props.toggle}>
                    ...
                    <ModalFooter>
                    <Link to={'/search/'+ this.state.criteria}><button onClick={() => {this.props.toggle()}} type="submit" className="btn btn-outline-dark waves-effect w-100 mb-2">Search</button></Link>
