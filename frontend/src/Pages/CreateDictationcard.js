    ...
    render() {
        ...
        return (
            <div>
                ...
                <div className="row">
                    <div className="col col-12 d-flex justify-content-center" style={{height: "50vh"}}>
                        {/* <DictationQuestionsCreate/> */}
...
const connectedCreateDictationcard = connect(mapStateToProps, null)(CreateDictationcard)
